...
<div id="profilePage" style="min-width:1200px; min-height:638px;">
	<div class="mt-4">
		<h3>기본 정보</h3>
	</div>
  <!-- /.box-header -->
	<div class="mt-3" style="margin-left:15px;margin-right:15px;border-top:1px solid #dee2e6;">
...
function deleteChkPop(){
	...
	window.open("member/check_delete.do", "chkForm", "width="+ popupWidth +", height="+ popupHeight +", left="+ popupX +", top="+ popupY +", resizable = no, scrollbars = no");
}
